...
for calA = ["1.0","1.05","1.10","1.15","1.20"]
    for seed = 1:10
        ...
        ax = gca;
        ax.FontSize = 24;
        saveas(gcf, output_dir + 'Fire'+seed, 'epsc')
        ...
        ax = gca;
        ax.FontSize = 24;
        saveas(gcf, output_dir + 'CellArea'+seed, 'epsc')
        ...
        ax = gca;
        ax.FontSize = 24;
        saveas(gcf, output_dir + 'U'+seed, 'epsc')
        ...
        if makeAMovie == 1
            moviestr = output_dir + 'confluence_'+fileheader+'seed_'+seed+'.mp4';
